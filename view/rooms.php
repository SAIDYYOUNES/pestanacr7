        ...
        <div class="bg-grey-lighter min-h-screen flex justify-center ">
            <div class="container  flex-1 flex flex-col items-center justify-center px-2">
                <div class="bg-white px-6 py-8 rounded shadow-md text-black w-9/12">
                    <form  method="POST">
                            <h1 class="mb-8 text-3xl text-center">Add an available room</h1>
                            <label for="">Room type:</label>
                        <select onchange="suitetype(value)" name="rtype" id="" class="block border border-grey-light w-full p-3 rounded mb-4">
                            <option value=""></option>
