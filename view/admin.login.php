...
<html lang="en">
  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <!--Hero-->
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center justify-around mb-5">
        <!--Left Col-->
        <div class=" bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col w-8/12 ">
            <form method="post">
            <div class="mb-4">
                <label class="block text-black text-sm font-bold mb-2" for="username">
                  Username
                </label>
                <input class="shadow text-black border rounded w-9/12 py-2 px-3 text-grey-darker" name="email" type="text" placeholder="Username">
              </div>
              <div class="mb-6">
                <label class="block text-black  text-sm font-bold mb-2" for="password">
                  Password
                </label>
                <input class="shadow text-black border border-red rounded w-9/12 py-2 px-3  mb-3" name="password" type="password" placeholder="******************">
                
              </div>
              <div class="flex items-center justify-center">
                <button class="bg-gray-800 hover:bg-blue-dark text-white font-bold py-2 px-4 rounded" type="submit" name="admin_login">
                  login
                </button>
        ...
        <div class="w-full flex flex-col md:flex-row py-6">
          ...
          <div class="flex-1">
            ...
            <ul class="list-reset mb-6">
              ...
              <li class="mt-2 inline-block mr-2 md:gblock md:mr-0">
