...
<html lang="en">
  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <!--Hero-->
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center justify-around">
        <!--Left Col-->
          ...
          <form  method="post">
                ...
                <div class="flex items-center justify-center">
                  ...
                  <a class="inline-block align-baseline font-bold text-sm text-gray-800 hover:text-blue-darker" href="signup.php">
                    ||creat your account
                  </a>
                </div>
              </form>
